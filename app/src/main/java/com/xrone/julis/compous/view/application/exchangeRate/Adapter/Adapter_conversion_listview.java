package com.xrone.julis.compous.view.application.exchangeRate.Adapter;
...
import com.xrone.julis.compous.view.application.exchangeRate.Data.Currency_Names;
...
public class Adapter_conversion_listview extends BaseAdapter{
	...
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		Log.e("view","反悔了list_curency_names.get(position)");
		return list_curency_names.get(position);
	}

	public long getItemId(int position) {
		// TODO Auto-generated method stub
		Log.e("view","反悔了position");
		return position;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.app_row_curency_converter, null);
