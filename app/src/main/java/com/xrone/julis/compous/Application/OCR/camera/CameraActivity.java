 ...
 */
package com.xrone.julis.compous.Application.OCR.camera;
...
import com.xrone.julis.compous.Application.OCR.crop.CropView;
import com.xrone.julis.compous.Application.OCR.crop.FrameOverlayView;
...
//        cameraView.setMaskType(maskType);
    ...
    private void updateFlashMode() {
        ...
        if (flashMode == ICameraControl.FLASH_MODE_TORCH) {
            lightButton.setImageResource(R.drawable.app_ocr_light_on);
        } else {
            lightButton.setImageResource(R.drawable.app_ocr_light_off);
        }
    }
