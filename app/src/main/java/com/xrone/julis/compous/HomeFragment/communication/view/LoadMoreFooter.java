...
public class LoadMoreFooter {
    ...
    public LoadMoreFooter(@NonNull Context context, @NonNull HeaderAndFooterRecyclerView recyclerView, @NonNull OnLoadMoreListener loadMoreListener) {
        ...
        View footerView = LayoutInflater.from(context).inflate(R.layout.com_footer_load_more, recyclerView.getFooterContainer(), false);
    ...
    public void setState(@State int state) {
        Log.e("satata", String.valueOf(state));
        if (this.state != state) {
            this.state = state;
            switch (state) {
                case STATE_DISABLED:
