...
import com.xrone.julis.compous.view.HomeFragment.communication.util.ResUtils;
...
public class NavigationItem extends FrameLayout implements Checkable {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
       LayoutInflater.from(context).inflate(R.layout.com_widget_navigation_item, this, true);
        ...
        //iconItem.setBackgroundColor(checked ? ResUtils.getThemeAttrColor(context, R.attr.actionBarDivider) : Color.TRANSPARENT);
        iconItem.setBackgroundColor(getResources().getColor(R.color.white));
    ...
    public void setChecked(boolean checked) {
        if (this.checked != checked) {
            ...
            iconItem.setBackgroundColor(checked ? ResUtils.getThemeAttrColor(getContext(), R.attr.windowActionBar) : Color.TRANSPARENT);
        }
    }
