package com.xrone.julis.compous.HomeFragment.communication.HeaderAndFooterRecyclerView;
...
public class ProxyAdapter  extends RecyclerView.Adapter{
    ...
    public ProxyAdapter(@NonNull HeaderAndFooterRecyclerView recyclerView) {
