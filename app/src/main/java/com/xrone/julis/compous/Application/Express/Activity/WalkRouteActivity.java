...
public class WalkRouteActivity extends Activity implements OnMapClickListener,
	...
	private double mylatitude,mylongitude,deslatitude,deslongitude;

	@Override
	protected void onCreate(Bundle bundle) {
		super.onCreate(bundle);
		setContentView(R.layout.app_express_route_activity);
	...
	private void setfromandtoMarker() {
		...
		.icon(BitmapDescriptorFactory.fromResource(R.drawable.app_express_way_start)));
		aMap.addMarker(new MarkerOptions()
		.position(AMapUtil.convertToLatLng(mEndPoint))
		.icon(BitmapDescriptorFactory.fromResource(R.drawable.app_express_way_end)));
	}
	...
	private void init() {
		...
		deslatitude=intent.getDoubleExtra("deslatitude",0);
		deslongitude=intent.getDoubleExtra("deslongitude",0);
		mStartPoint= new LatLonPoint(mylatitude, mylongitude);
		mEndPoint = new LatLonPoint(deslatitude, deslongitude);
...
//							startActivity(intent);
	...
	public void showAlertDialog(){
		AlertDialog isToNavigationAlert = new AlertDialog.Builder(WalkRouteActivity.this).create();
		...
		isToNavigationAlert.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.string.ok), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				...
				intent.putExtra("desLongtitude", deslongitude);
				startActivity(intent);
			}
