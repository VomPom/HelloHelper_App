...
import com.xrone.julis.compous.HomeFragment.communication.Model.ApiDefine;
import com.xrone.julis.compous.HomeFragment.communication.Model.Topic;
import com.xrone.julis.compous.HomeFragment.communication.TopicActivity;
...
public final class Navigator {
    ...
    public static final class TopicWithAutoCompat {
        ...
        public static void start(@NonNull Activity activity, @NonNull Topic topic) {
            ...
            Log.e("EXTRA_TOPIC_ID",EntityUtils.gson.toJson(topic));
